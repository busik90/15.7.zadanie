...
var Stopwatch = function () {
  function Stopwatch(display, scores) {
...
var stopwatch = new Stopwatch(document.querySelector('.stopwatch'), document.querySelector('.scoresTable'));
